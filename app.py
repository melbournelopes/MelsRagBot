...
class app:
    def __init__(self):
        ...
        self.embeddings = HuggingFaceEmbeddings(model_name="all-MiniLM-L6-v2", huggingfacehub_api_token=st.secrets.get("HUGGING_FACE_TOKEN", None))

        # Initialize Language Model
        self.llm = ChatGroq(groq_api_key=st.secrets.get("GROQ_API_KEY"),
